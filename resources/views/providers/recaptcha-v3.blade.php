...
@if (setting('captcha_show_disclaimer'))
    ...
    >
        {!! BaseHelper::clean(
            trans('plugins/captcha-pro::captcha-pro.recaptcha_disclaimer_message_with_link', [
                'privacyLink' => Html::link(
                    'https://www.google.com/intl/en/policies/privacy/',
                    trans('plugins/captcha-pro::captcha-pro.privacy_policy'),
                    ['target' => '_blank'],
                ),
                'termsLink' => Html::link(
                    'https://www.google.com/intl/en/policies/terms/',
                    trans('plugins/captcha-pro::captcha-pro.terms_of_service'),
                    ['target' => '_blank'],
                ),
            ]),
        ) !!}
