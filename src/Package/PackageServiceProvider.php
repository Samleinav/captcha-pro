...
namespace Botble\CaptchaPro\Package;
...
use Botble\CaptchaPro\Package\Http\Controllers\EntomaiPluginsController;
 ...
 * Replace every occurrence of "Botble\CaptchaPro" with your plugin namespace,
...
class PackageServiceProvider extends ServiceProvider
{
    ...
    public function addAdminToolsUpdateItems(array $items): array
    {
        try {
            ...
            // Silently fail — never break the admin header for an update check
        }
